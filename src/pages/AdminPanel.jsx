  ...
  useEffect(() => {
    const loadPendingData = async () => {
      const { data, error } = await supabase
        .from("appointments")
        .select("id, client_name, treatment_name, appointment_date, appointment_time, status")
        .eq("status", "Pending")
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", flex: 1 }}>
            ...
            <p style={{ margin: "4px 0 0 0", fontSize: "14px", color: "#6b7280" }}>
              Welcome back, <span className="highlight" style={{ fontWeight: "600", color: "#111827" }}>{profile?.full_name || "Admin"}</span>
            </p>
          </div>
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", padding: "16px 20px", borderBottom: "1px solid #f3f4f6" }}>
              <div style={{ textAlign: "left" }}>
                ...
                <p style={{ margin: "2px 0 0 0", fontSize: "12px", color: "#6b7280", textAlign: "left" }}>
            ...
            <div style={{ overflowY: "auto", padding: "8px", maxHeight: "400px", backgroundColor: "#f9fafb" }}>
              {pendingItems.length === 0 ? (
                <div style={{ textAlign: "center", padding: "40px 20px" }}>
                  ...
                  <h4 style={{ margin: "0 0 4px 0", fontSize: "14px", fontWeight: "500", color: "#374151" }}>All caught up!</h4>
                  <p style={{ margin: 0, fontSize: "12px", color: "#9ca3af" }}>No pending requests requiring review.</p>
                </div>
              ) : (
